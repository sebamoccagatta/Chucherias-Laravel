        ...
        <div class="centro">
          ...
          <ul id="menu">
           ...
           <li><input type="checkbox" name="list" id="facturacion"><label for="facturacion">Facturacion</label>
             <ul class="interior">
               <li><a href="#r">Formas de facturacion</a></li>
               <li><a href="#r"></a>Factura B</li>
             </ul>
           </li>
           ...
           <li><input type="checkbox" name="list" id="devoluciones"><label for="devoluciones">Devoluciones</label>
             <ul class="interior">
               <li><a href="#r">Cancelar un pedido</a></li>
               <li><a href="#r">Garantias</a></li>
               <li><a href="#r">Devoluciones</a></li>
             </ul>
           </li>
